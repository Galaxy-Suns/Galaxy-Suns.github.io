...
对于输出一些中间向量的Transformer称为Transformer**编码器**

![](./img/6d2ff0fc.png)

对于输出目标序列的Transform称为**解码器**

![](./img/5518b2aa.png)

* 语言模型
* 图像模型 ViT Vision Transformers
将图像分割为若干块 将每一款投影到一个向量 *Token*
形成的向量序列作为输入 *我们失去了碎片在原图像的位置 因此通常使用位置嵌入 *
